...
function blendDarken(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendMultiply(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendColorBurn(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendLinearBurn(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendDarkerColor(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendLighten(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendScreen(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendColorDodge(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendLinearDodge(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendLighterColor(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendOverlay(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendSoftLight(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendHardLight(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendVividLight(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendLinearLight(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendPinLight(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendHardMix(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendDifference(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendExclusion(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendSubtract(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendDivide(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendHue(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendSaturation(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendColor(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
...
function blendLuminosity(d: Uint8ClampedArray, s: Uint8ClampedArray, w: number, h: number, alpha: number): void {
    let sr: number, sg: number, sb: number, sa: number, dr: number, dg: number, db: number, da: number;
    let a1: number, a2: number, a3: number, r: number, g: number, b: number, a: number, tmp: number;
    for (let i = 0, len = w * h << 2; i < len; i += 4) {
        sr = s[i];
